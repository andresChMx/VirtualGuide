...
class ExperienceProvider {
  ...
  Future<ExperienceDetailed> getExperienceDetail(String experienceId) async {
    final url = Uri.parse(
        'https://vguidebe.herokuapp.com/api/places/tp/$experienceId/');
  ...
  Future<List<Department>> getFavoriteExperiencesDepartments() async {
    ...
    final url = Uri.parse(
        'https://vguidebe.herokuapp.com/api/users/$userId/favourites/departments/'); //TODO: Correct url
  ...
  Future<List<Experience>> getFavoriteExperiences(String departmentId) async {
    ...
    final int userId = UserPreferences().getUserId();
    final url = Uri.parse(
        'https://vguidebe.herokuapp.com/api/users/$userId/favourites/departments/$departmentId/'); //TODO: Correct url
  ...
  Future postAddFavoriteExperience(String experienceId) async {
    final url = Uri.parse(
        'https://vguidebe.herokuapp.com/api/users/favourite/create/'); //TODO: Correct url
