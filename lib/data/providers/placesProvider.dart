...
class PlacesProvider {
  ...
  Future<List<dynamic>> getLocations(String searchTerm) async {
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/place/autocomplete/json?key=$_apiKey&input=$searchTerm');
    try {
  ...
  Future<Map> getLocationDetail(String placeId) async {
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/place/details/json?key=$_apiKey&place_id=$placeId');
